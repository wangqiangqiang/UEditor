...
UE.I18N['zh-cn'] = {
    ...
    'help':{
        'static':{
            'lang_input_about':'关于雨和信息',
            'lang_input_shortcuts':'快捷键',
            'lang_input_version':'版本:1.2.6',
            'lang_input_introduction': '雨和信息是上海市认定的高新技术企业，企业核心骨干由来自上海各大院校毕业的博士和留学归国人员组成。公司自成立以来致力于政府信息化建设的整体规划、设计和项目开发，高度注重对技术的创新和产品的研发，截至目前，企业已拥有多个个具有自主知识产权的软件产品和解决方案。已与上海多个区政府部门有过多次成功项目合作经验和成功案例。',
